...
> **마지막 전통적 개발 교육을 수료한 세대의 공학자.**
> 
> **Engineer of the last generation formally trained in traditional software development before the AI era.**

I am genuinely proficient in **Modern C++**, **Python 3**, and **Java**.

My background is in **traditional backend development**, with a focus on **Hexagonal Architecture**, **agile and incremental delivery**, **TDD/BDD**, **data structures**, and competent use of **databases and algorithms**.

In the AI era, I can also work comfortably with **Vue 3**, **TypeScript**, **PostgreSQL**, and **SQLite**.

My strength lies in understanding **business processes**, identifying **pain points**, consolidating **requirements**, and designing **practical functionality**.

I see myself as a **full-stack business professional**, rather than a purely technical specialist.

My engineering philosophy is shaped by **Modern C++** and ***The Mythical Man-Month*:** **disciplined ownership**, **clear boundaries**, **modular aggregation**, and **realistic project planning**.

## Visual Tech Stack

<!-- C++ Ecosystem -->
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,cmake,opencv&theme=light" valign="middle" />
  &#8205;
  <img src="https://raw.githubusercontent.com/JeongHan-Bae/JeongHan-Bae/main/assets/img/boost.svg" width="49" valign="middle" />
  &#8205;
  <img src="https://raw.githubusercontent.com/JeongHan-Bae/JeongHan-Bae/main/assets/img/protobuf.svg" width="49" valign="middle" />
</p>
...
<!-- Web Frontend -->
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,vite,vue,tailwind,pinia&theme=light" />
</p>
